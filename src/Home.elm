        ...
        , Grid.row [ Row.centerXs, Row.attrs [] ]
            ...
            , Grid.col [Col.md4]
                [ h3 [ style "color" "rgb(121,20,60)", style "text-align" "center" ]
                    [ text "We have taught 26,131 new coders from over 1017 classes!" ]
                ]
            ]
...
leftBlock =
    Grid.container []
        ...
        ,-} Grid.row [ Row.attrs [ Spacing.py1 ] ]
            [ Grid.col []
                [  h4 [ Spacing.mb2 ] [ text "Parents:" ]
                , text "Learn about our camps:"
                ]
            ]
        , Grid.row [ Row.attrs [ Spacing.py1 ] ]
            [ Grid.col []
                [ Button.linkButton 
                    [Button.attrs [
                        Size.w50
                        , style "float" "center"
                        , href "mailto:mcmasteroutreach@gmail.com"
                        , style "color" "white"
                        , style "background-color" "maroon"
                        , style "border-radius" "12px"
                    ]         
                    , Button.block] [text "Get on waiting list!"]
                ]
            ]
